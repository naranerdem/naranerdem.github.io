...
assert.match(programsSource, /id="program-copy"[^>]*aria-label="Excel-д хуулах"[^>]*>Хуулах</);
assert.match(scheduleSource, /Жилийн хуваарь хэвлэх \/ PDF/);
assert.match(scheduleSource, /id="annual-schedule-copy"[^>]*aria-label="Excel-д хуулах"[^>]*>Хуулах</);
assert.match(scheduleSource, /id="class-schedule-copy"[^>]*aria-label="Excel-д хуулах"[^>]*>Хуулах</);
