...
assert.match(page, /get\("diagnostics"\) === "payment-timing"/, "payment timing is opt-in through one explicit diagnostics parameter");
assert.match(page, /naran-erdem-staging\.naranerdem-github-io\.workers\.dev/, "the timing surface is restricted to staging rather than production");
assert.match(page, /get\("diagnostics"\) === "datetime-layout"/, "date-time layout diagnostics require one explicit staging/local query parameter");
