...
export function registrationConfirmationTemplate(verificationUrl: string) {
  ...
  return {
    subject: "Наран Эрдэм — И-мэйл хаягаа баталгаажуулна уу",
    html: `<!doctype html>
<html lang="mn">
  <body style="margin:0;padding:24px;background:#f8fafc;color:#172033;font-family:Arial,sans-serif;line-height:1.5">
    <div style="max-width:560px;margin:0 auto;background:#ffffff;padding:24px;border:1px solid #dfe4ec;border-radius:8px">
      ...
      <p>Наран Эрдэмийн бүртгэлд энэ и-мэйл хаягийг ашигласан байна. Доорх товчийг дарж хаягаа баталгаажуулна уу.</p>
      <p>Төлбөрийн мэдээллийг бүртгэл илгээсний дараа шууд ашиглаж болно. И-мэйлээ баталгаажуулснаар бүртгэлийн мэдээллээ дараа нь хялбар харах, удирдах боломжтой.</p>
...
Наран Эрдэмийн бүртгэлд энэ и-мэйл хаягийг ашигласан байна. Доорх холбоосоор и-мэйл хаягаа баталгаажуулна уу.

Төлбөрийн мэдээллийг бүртгэл илгээсний дараа шууд ашиглаж болно. И-мэйлээ баталгаажуулснаар бүртгэлийн мэдээллээ дараа нь хялбар харах, удирдах боломжтой. Холбоос 24 цагийн дараа хүчингүй болно.
