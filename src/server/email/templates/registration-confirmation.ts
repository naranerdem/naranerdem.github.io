...
<html lang="mn">
  <body style="margin:0;padding:24px;background:#f8fafc;color:#172033;font-family:Arial,sans-serif;line-height:1.5">
    <div style="max-width:560px;margin:0 auto;background:#ffffff;padding:24px;border:1px solid #dfe4ec;border-radius:8px">
      ...
      <p>Төлбөрийн мэдээллийг бүртгэл илгээсний дараа шууд ашиглаж болно. И-мэйлээ баталгаажуулбал төлөвийн мэдэгдлийг энэ хаягаар авах боломжтой.</p>
...
Төлбөрийн мэдээллийг бүртгэл илгээсний дараа шууд ашиглаж болно. И-мэйлээ баталгаажуулбал төлөвийн мэдэгдлийг энэ хаягаар авах боломжтой. Холбоос 24 цагийн дараа хүчингүй болно.
