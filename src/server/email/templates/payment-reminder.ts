...
function deadline(value: string): string { const date = new Date(value); return Number.isNaN(date.getTime()) ? value : date.toLocaleString("mn-MN", { dateStyle: "medium", timeStyle: "short", timeZone: "Asia/Ulaanbaatar" }); }
...
export function paymentReminderTemplate(input: {
  ...
  const lead = overdue
    ? "Төлбөрийн хугацаа өнгөрсөн байна. Таны хүүхдийн суудал автоматаар цуцлагдаагүй."
