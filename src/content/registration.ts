...
export const registrationFormCopy = {
  ...
  child: {
    title: "Хүүхэд",
    help: "Нэг асран хамгаалагч хэд хэдэн хүүхэд нэмж болно.",
    cardTitle: "Хүүхэд",
    surname: "Овог",
    name: "Нэр",
    gender: "Хүйс",
    ...
    previousStageHelp: "Өмнө сурч байсан бол сонгоно уу.",
    referralCode: "Авсан урилгын код",
    referralCodeHelp: "Танд өөр айлаас өгсөн код байгаа бол оруулна уу.",
    stage: "Сургалтын шат",
    stageHelp: "Сонголтыг дараа нь өөрчилж болно.",
    recommendation: "Өмнөх шатны мэдээллээр {stage}-г санал болгож байна.",
    recommendationUnknown: "Шатыг сонгоно уу.",
    stageLabels: {
  ...
  classChoice: {
    title: "Сургалтын шат, анги",
    loading: "Боломжит ангиудыг авч байна…",
    unavailable: "Анги, суудлын мэдээлэл одоогоор түр боломжгүй байна.",
    chooseStage: "Эхлээд сургалтын шатаа сонгоно уу.",
    noSessions: "Энэ шатанд одоогоор нийтлэх анги алга байна.",
    remainingSeats: "Сул суудал: {count}",
    full: "Анги дүүрсэн",
    activeHolds: "Төлбөр баталгаажихыг хүлээж буй бүртгэл: {count}",
